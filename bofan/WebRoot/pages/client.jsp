  ...
  <head>
    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		$("#file1").change(function(){
    			...
    			if(filePath){
    				...
    				$("#fileForm").form("submit",{
    					url:"<%=path%>/clientAction/importClient.action",
    					success:function(r){
    						hideLoading();
    						var r = $.evalJSON(r);
    						if(r.result) {
    		...
    		<% if(user.getLimitsLevel()!=null && user.getLimitsLevel().intValue()!=0) {%>
    		//转移按钮
    		...
    		$("#dialog5").dialog({
    			...
    			buttons:[{
    				...
    				handler:function(){
    	    			...
    	    			var id = $("#userId5").combobox("getValue");
		           ...
		           <table cellspacing="0" cellpadding="0">
		              <tbody>
		                  <tr>
		                     ...
		                     <td><a href="<%=path %>/template/dianHuaRiBao.xls" class="easyui-linkbutton" data-options="iconCls:'icon-excel',plain:true">模板</a></td>
		                     <td><div class=" datagrid-btn-separator"></td>
  	...
  	<div id="dialog5">
  		<form id="form5">
	  		<table class="myTable">
	  			<tr>
	  				<td>业务员：</td>
	  				<td><input type="text" id="userId5" name="userId" data-options=""/></td>
	  			</tr>
	  		</table>
  		</form>
  	</div>
